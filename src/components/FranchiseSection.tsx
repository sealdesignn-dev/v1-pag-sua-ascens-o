        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              <img alt="Franqueado V1 Pag de sucesso" className="w-full h-auto object-cover" src="/lovable-uploads/0dbb8c8a-99a3-4c12-b3e4-4df4cb635623.png" />
            </div>
            {/* Decorative element */}
          ...
          <div className="space-y-8 order-1 lg:order-2">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {highlights.map((highlight, index) => <Card key={index} className="p-6 bg-[hsl(29,100%,50%)] border-[hsl(29,100%,50%)] hover:bg-[hsl(29,100%,55%)] transition-all duration-300">
